    ...
    <>
      <Menu mode="horizontal" selectedKeys={[current]} >
        <Menu.Item key="dashboard" icon={<MailOutlined />}>
          <a href="/performance/mysql/health" rel="noopener noreferrer">
            MySQL健康大盘
          </a>
        </Menu.Item>
        <Menu.Item key="chart" icon={<AppstoreOutlined />}>
          <a href="/performance/mysql/chart" rel="noopener noreferrer">
            MySQL性能图表
          </a>
        </Menu.Item>
      </Menu>
        ...
        >
          <Space>
            <Form.Item
              name={'instance'}
              label={'选择MySQL实例'}
              rules={[{ required: true, message: '请选择MySQL实例' }]}
            >
              <Select showSearch style={{ width: 260 }} placeholder="请选择MySQL实例">
