...
const OracleChart: React.FC = () => {
  ...
  useEffect(() => {
    setCurrent("chart");
    fetch('/api/v1/meta/node/list_search?module=oracle')
  ...
  const asyncFetch = (values: {}) => {
    ...
    fetch('/api/v1/performance/oracle/chart', {
      method: 'post',
      headers: headers,
  ...
  return (
    <>
        ...
        >
          <Space>
            <Form.Item
              name={'instance'}
              label={'选择Oracle实例'}
              rules={[{ required: true, message: '选择Oracle实例' }]}
            >
      ...
      {
        data.sessionChartList && data.sessionChartList.length > 0 &&
        <>
          <Row gutter={[16, 24]}>
            <Col span={12}>
              <Card style={{ marginTop: 10 }}>
                <div style={{ height: 300 }}>
                  <LineChart data={data.sessionChartList} unit="" />
                </div>
              </Card>
            </Col>
            <Col span={12}>
              <Card style={{ marginTop: 10 }}>
                <div style={{ height: 300 }}>
                  <LineChart data={data.trxChartList} unit="" />
                </div>
              </Card>
            </Col>
          </Row>
          <Row gutter={[16, 24]}>
            <Col span={12}>
              <Card style={{ marginTop: 10 }}>
                <div style={{ height: 300 }}>
                  <LineChart data={data.physicalWriteReadChartList} unit="" />
                </div>
              </Card>
            </Col>
            <Col span={12}>
              <Card style={{ marginTop: 10 }}>
                <div style={{ height: 300 }}>
                  <LineChart data={data.IoRequestChartList} unit="" />
                </div>
              </Card>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 24]}>
            <Col span={12}>
              <Card style={{ marginTop: 10 }}>
                <div style={{ height: 300 }}>
                  <LineChart data={data.dbBlockChartList} unit="" />
                </div>
              </Card>
            </Col>
            <Col span={12}>
              <Card style={{ marginTop: 10 }}>
                <div style={{ height: 300 }}>
                  <LineChart data={data.logonsChartList} unit="" />
                </div>
              </Card>
            </Col>
          </Row>
          ...
          <Row gutter={[16, 24]}>
            <Col span={12}>
              <Card style={{ marginTop: 10 }}>
                <div style={{ height: 300 }}>
                  <LineChart data={data.osCpuChartList} unit="" />
                </div>
              </Card>
            </Col>
            <Col span={12}>
              <Card style={{ marginTop: 10 }}>
                <div style={{ height: 300 }}>
                  <LineChart data={data.dgDelayChartList} unit="kb" />
                </div>
              </Card>
            </Col>
          </Row>
