...
const CreateForm: React.FC<CreateFormProps> = (props) => {
  ...
  useEffect(() => {
    console.log('CreateForm useEffect triggered:', { updateModalVisible, values });
  ...
  console.log('CreateForm render:', { updateModalVisible, values });
  ...
  return (
    <ModalForm
      ...
      onOpenChange={(open) => {
        console.log('ModalForm onOpenChange:', open);
        if (!open) {
          form.resetFields();
          onCancel();
        }
