...
type ApiConfig struct {
	Id             int64     `gorm:"primarykey" json:"id"`
	ApiName        string    `gorm:"size:100" json:"api_name"`
	ApiUrl         string    `gorm:"size:500" json:"api_url"`
	ApiDescription string    `gorm:"size:300" json:"api_description"`
	...
	ExpectedCodes  string    `gorm:"size:200;default:'200'" json:"expected_codes"`
...
type TaskLog struct {
	Id           int64      `gorm:"primarykey" json:"id"`
	TaskKey      string     `gorm:"size:50;index" json:"task_key"`
...
type PumpkinTableSize struct {
	...
	IndexSize      int64     `gorm:"default:0" json:"index_size"`     // 索引大小(字节)
	FreeSize       int64     `gorm:"default:0" json:"free_size"`      // 空闲大小(字节)
	TableRows      int64     `gorm:"default:0" json:"table_rows"`     // 表行数
	AvgRowLength   int64     `gorm:"default:0" json:"avg_row_length"` // 平均行长度
	CreatedAt      time.Time `gorm:"column:gmt_created" json:"gmt_created"`
	UpdatedAt      time.Time `gorm:"column:gmt_updated" json:"gmt_updated"`
}
